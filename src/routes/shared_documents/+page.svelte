<script>
    ...
    let isLoading = true;
    let error = null;
    let currentPath = 'Study documents';
    ...
    async function loadRepositoryContents(path) {
      try {
        ...
        if (!path.startsWith('Study documents')) {
...
<div class="container mx-auto p-6 max-w-8xl">
  <div class="mb-8">
    <h1 class="text-3xl font-bold mb-2">Study Documents</h1>
    <p class="text-base-content/70">Access study documents and resources</p>
  </div>

  <!-- Current path and back button -->
  <div class="flex items-center justify-between mb-6">
    <div class="flex items-center gap-4">
      {#if currentPath !== 'Study documents'}
        <button 
      ...
      <div class="text-sm breadcrumbs">
        <ul>
          <li><a href="#" on:click|preventDefault={() => navigateToFolder('Study documents')}>Documents</a></li>
