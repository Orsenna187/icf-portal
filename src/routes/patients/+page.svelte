...
<div class="container mx-auto p-6 max-w-8xl">
    <div class="mb-6">
        <h1 class="text-3xl font-bold mb-2">Patients</h1>
    </div>
    ...
    <!-- Fixed Add Patient button at bottom right -->
    <div class="fixed bottom-8 right-8">
        <button class="btn btn-primary btn-circle shadow-lg" on:click={openAddModal} title="Add Patient">
